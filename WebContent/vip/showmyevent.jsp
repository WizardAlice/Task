...
<div class="container">
            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse fadeInDown animated" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav animated fadeInDown">
                        <li class="active">
                            <a href="/Library/vip/gameview.jsp">近期赛事</a>
                        </li>
 
                        <li>
                            <a href="/Library/vip/changeinfo.jsp">我的信息</a>
                        </li>
                        <li>
                            <a href="#">已参加赛事</a>
                        </li>
  ...
  while(resultSet.next()){
	  eventindex = resultSet.getString("bievent");
	  gameid = resultSet.getString("game_id");
	  resultSet2 = libSystem.eventname(eventindex, gameid);
	  resultSet3 = libSystem.gamename(gameid);
	  while(resultSet3.next()){%>
		  <div class="container_1 animated fadeInDown">
		   <div class="jumbotron"><h2 text-align:left><%= resultSet3.getString("name")%></h2>
		   <%while(resultSet2.next()){ %>
        <p>项目名称：<%=resultSet2.getString("name")%></p>
        <%} %>
