    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="Rigister" class="form col-md-12 center-block">
          ...
          <span style="font-size:30px">注册信息</span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
          <span class="span01">两次密码不一致！</span> <br><br><br>
